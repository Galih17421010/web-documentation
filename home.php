...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="http://localhost/laravel-doc/home.html" />
    ...
    <meta property="twitter:url" content="http://localhost/laravel-doc/home.html" />
  ...
  <body x-data="{navIsOpen: false,}" class="w-full h-full font-sans antialiased text-gray-900 language-php" data-instant-intensity="0">
          ...
          <div class="max-w-screen-xl mx-auto px-5 flex items-center justify-between">
            <div class="flex-1">
              <a href="/" class="inline-flex items-center">
                <img class="w-12" src="assets/img/logomark.min.svg" alt="Laravel" width="50" height="52" />
                <img class="ml-5 sm:block" src="assets/img/logotype.min.svg" alt="Laravel" width="114" height="29" />
              </a>
            </div>
      ...
      <div class="max-w-screen-xl w-full mx-auto px-5 grid gap-12 lg:grid-cols-2">
        <div class="flex justify-center items-center">
          <svg class="w-[302px] lg:w-[454px] max-w-full" width="454" height="219" viewBox="0 0 454 219" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M227.5 16.875L235.375 12.375L243.25 16.875L235.375 21.375L227.5 16.875ZM227.5 16.875V25.875M227.5 25.875L235.375 30.375M227.5 25.875L211.75 34.875"
              stroke="#FF2D20"
              stroke-width="1.5"
            ...
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M282.878 185.417C286.938 179.381 287.042 172.687 283.192 165.333C286.046 168.255 287.808 172.264 287.808 176.688C287.808 179.245 287.22 181.661 286.173 183.811C285.578 184.675 285.124 185.741 283.913 185.741C283.543 185.744 283.181 185.631 282.878 185.417Z"
              fill="#E24CA6"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M271.483 180.707C276.871 180.707 279.139 177.583 279.139 173.148C279.139 168.712 275.711 164.63 271.483 164.63C267.254 164.63 263.826 168.712 263.826 173.148C263.826 177.584 266.094 180.707 271.483 180.707Z"
              fill="white"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M272.295 170.233C272.295 171.981 271.009 173.4 269.424 173.4C267.837 173.4 266.552 171.981 266.552 170.233C266.552 168.484 267.837 167.065 269.424 167.065C271.009 167.065 272.295 168.484 272.295 170.233Z"
              fill="#030776"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M270.38 169.502C270.38 170.309 269.738 170.963 268.945 170.963C268.151 170.963 267.509 170.309 267.509 169.502C267.509 168.695 268.151 168.041 268.945 168.041C269.738 168.041 270.38 168.695 270.38 169.502Z"
              fill="white"
            />
            <path
              d="M168.922 163.007C168.922 163.007 175.139 166.561 176.766 172.207C178.232 177.307 177.058 179.741 177.058 179.741C177.808 180.558 178.399 181.507 178.8 182.541C179.203 183.205 179.44 183.957 179.491 184.732C179.541 185.507 179.404 186.283 179.09 186.994C179.09 186.994 178.99 184.914 175.89 184.483C173.049 184.083 172.016 186.849 166.59 186.715C163.584 186.658 160.637 185.866 158.007 184.409C155.376 182.951 153.143 180.873 151.5 178.354C154.151 179.8 157.624 182.045 161.949 181.7C166.274 181.355 167.177 180.026 167.177 180.026C162.315 176.179 158.012 171.675 154.391 166.643C157.791 169.488 166.213 175.15 166.017 175.006C162.936 171.996 160.118 168.729 157.592 165.24C157.592 165.24 170.228 175.629 171.245 175.563C171.663 174.702 173.824 170.245 168.921 163.006L168.922 163.007Z"
        ...
        <div class="w-full flex justify-center items-center">
          <div class="sm:max-w-[480px]">
            ...
            <p class="mt-6 text-gray-700 leading-relaxed">
              Build robust, full-stack applications in PHP using Laravel and <a class="underline" href="https://livewire.laravel.com">Livewire</a>. Love JavaScript? Build a monolithic React or Vue driven frontend by pairing Laravel with
              <a class="underline" href="https://inertiajs.com">Inertia</a>.
            </p>
            <p class="mt-6 text-gray-700 leading-relaxed">
        ...
        <div x-data="{
            ...
            >
              <li>
                <a
                  ...
                  :class="tab === 'authentication' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('authentication')"
                >
              ...
              <li>
                <a
                  href="#authorization"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'authorization' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('authorization')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                    <path
                      stroke-linecap="round"
              ...
              <li>
                <a
                  href="#eloquent"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'eloquent' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('eloquent')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                    <path
                      stroke-linecap="round"
              ...
              <li>
                <a
                  href="#migrations"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'migrations' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('migrations')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                    <path
                      stroke-linecap="round"
              ...
              <li>
                <a
                  href="#validation"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'validation' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('validation')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                    <path
                      stroke-linecap="round"
              ...
              <li>
                <a
                  href="#notifications"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'notifications' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('notifications')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                    <path
                      stroke-linecap="round"
              ...
              <li>
                <a
                  href="#storage"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'storage' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('storage')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                    <path
                      stroke-linecap="round"
              ...
              <li>
                <a
                  href="#queues"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'queues' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('queues')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
              ...
              <li>
                <a
                  href="#scheduling"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'scheduling' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('scheduling')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
              ...
              <li>
                <a
                  href="#testing"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'testing' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
                  @click.prevent="changeTab('testing')"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
              ...
              <li>
                <a
                  href="#events"
                  class="text-left p-4 lg:py-6 flex items-center gap-3"
                  :class="tab === 'events' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'"
          ...
          <div class="flex-1 overflow-y-auto">
            ...
            <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'authentication'">
              ...
              <div
                class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4"
              >
        ...
        <div class="relative w-full grid gap-12 lg:grid-cols-2">
          ...
          <div class="w-full flex justify-center items-center px-5 xl:px-0">
            <div class="sm:max-w-[480px]">
              ...
              <p class="mt-6 text-gray-700 leading-relaxed">
                Laravel is committed to delivering the best testing experience you can imagine. No more brittle tests that are a nightmare to maintain. Beautiful testing APIs, database seeding, and painless browser testing let you ship with
                confidence.
              </p>
    ...
    <div class="max-w-screen-xl mx-auto px-5 pt-16 pb-24 md:pt-24 lg:pt-48">
      <div class="sm:max-w-xl">
        ...
        <p class="mt-6 text-gray-700 leading-relaxed">
          Our vast library of meticulously maintained packages means you're ready for anything. Let <a class="underline" href="/docs/octane">Laravel Octane</a> supercharge your application's performance, and experience infinite scale on
          <a class="underline" href="https://vapor.laravel.com">Laravel Vapor</a>, our serverless deployment platform powered by AWS Lambda.
        </p>
      </div>
        ...
        <li>
          <a href="https://forge.laravel.com" class="flex items-start pt-4 pb-6 px-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-forge flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              ...
              <img src="assets/img/ecosystem/forge.min.svg" alt="Forge Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
        ...
        <li>
          <a href="https://vapor.laravel.com" class="flex items-start pt-4 pb-6 px-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-vapor flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/vapor.min.svg" alt="Vapor Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Vapor</div>
        ...
        <li>
          <a href="https://envoyer.io" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-envoyer flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/envoyer.min.svg" alt="Envoyer Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Envoyer</div>
        ...
        <li>
          <a href="https://herd.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-herd flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/herd.min.svg" alt="Herd Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Herd</div>
              <div class="mt-1 text-sm text-gray-700">The fastest Laravel local dev environment - now for macOS and Windows.</div>
            </div>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="https://inertiajs.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-inertia flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/inertia.min.svg" alt="Inertia Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Inertia</div>
        ...
        <li>
          <a href="https://jetstream.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-jetstream flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/jetstream.min.svg" alt="Laravel Jetstream Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Jetstream</div>
        ...
        <li>
          <a href="https://livewire.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-livewire flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/livewire.min.svg" alt="Laravel Livewire Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Livewire</div>
        ...
        <li>
          <a href="https://nova.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-nova flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/nova.min.svg" alt="Laravel Nova Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Nova</div>
        ...
        <li>
          <a href="https://pulse.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-pulse flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/pulse.min.svg" alt="Laravel Pulse Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Pulse</div>
        ...
        <li>
          <a href="https://reverb.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-reverb flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/reverb.min.svg" alt="Laravel Reverb Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Reverb</div>
        ...
        <li>
          <a href="https://spark.laravel.com" class="flex p-4 border border-gray-200 border-opacity-60">
            <div class="relative shrink-0 bg-spark flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
              <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
              <img src="assets/img/ecosystem/spark.min.svg" alt="Laravel Spark Logo" class="relative w-7 h-7" width="28" height="28" loading="lazy" />
            </div>
            <div class="ml-4 leading-5">
              <div>Spark</div>
    ...
    <div class="relative max-w-screen-xl mx-auto px-5 pt-16 md:pt-24 lg:pt-36 pb-24">
      ...
      <h2 class="text-4xl font-bold max-w-4xl mx-auto text-center md:text-5xl">Loved by thousands of developers around the world.</h2>
      <div class="mt-14 relative columns-1 gap-5 space-y-5 sm:columns-2 lg:columns-3">
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/adam-wathan.jpg" class="w-10 h-10 object-cover object-center" alt="Adam Wathan" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/aaron-francis.jpg" class="w-10 h-10 object-cover object-center" alt="Aaron Francis" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/bobby-bouwmann.jpg" class="w-10 h-10 object-cover object-center" alt="Bobby Bouwmann" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          <h2 class="text-sm">
            “As an old school PHP developer, I have tried many frameworks; none has given me the development speed and enjoyment of use that I found with Laravel. It is a breath of fresh air in the PHP ecosystem, with a brilliant community
            around it.“
          </h2>
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/erika-heidi.jpg" class="w-10 h-10 object-cover object-center" alt="Erika Heidi" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/caleb-porzio.jpg" class="w-10 h-10 object-cover object-center" alt="Caleb Porzio" width="40" height="40" loading="lazy" />
            <div class="text-xs">
              <cite class="not-italic">Caleb Porzio</cite>
              <p class="text-gray-700">Creator of <a href="https://livewire.laravel.com" target="_blank" class="text-red-500">Livewire</a> and <a href="https://alpinejs.dev" target="_blank" class="text-red-500">Alpine.js</a></p>
            </div>
          </div>
        </blockquote>
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          <h2 class="text-sm">
            “I found Laravel by chance, but I knew right away that I found my thing. The framework, the ecosystem and the community - it’s the perfect package. I’ve worked on amazing projects and met incredible people; it’s safe to say that
            Laravel changed my life.“
          </h2>
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/zuzana-kunckova.jpg" class="w-10 h-10 object-cover object-center" alt="Zuzana Kunckova" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/michael-dyrynda.jpg" class="w-10 h-10 object-cover object-center" alt="Michael Dyrynda" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/chris-arter.jpg" class="w-10 h-10 object-cover object-center" alt="Chris Arter" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/eric-l-barnes.jpg" class="w-10 h-10 object-cover object-center" alt="Eric L. Barnes" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          <h2 class="text-sm">
            “I&#039;ve been enjoying Laravel&#039;s focus on pushing developer experience to the next level for many years. All pieces of the ecosystem are powerful, well designed, fun to work with, and have stellar documentation. The
            surrounding friendly and helpful community is a joy to be a part of.“
          </h2>
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/freek-van-der-herten.jpg" class="w-10 h-10 object-cover object-center" alt="Freek Van der Herten" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/jason-beggs.jpg" class="w-10 h-10 object-cover object-center" alt="Jason Beggs" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/joseph-silber.jpg" class="w-10 h-10 object-cover object-center" alt="Joseph Silber" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/steve-mcdougall.jpg" class="w-10 h-10 object-cover object-center" alt="Steve McDougall" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/philo-hermans.jpg" class="w-10 h-10 object-cover object-center" alt="Philo Hermans" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/luke-downing.jpg" class="w-10 h-10 object-cover object-center" alt="Luke Downing" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/tony-lea.jpg" class="w-10 h-10 object-cover object-center" alt="Tony Lea" width="40" height="40" loading="lazy" />
            <div class="text-xs">
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
          ...
          <div class="mt-5 flex items-start gap-4">
            <img src="/images/testimonials/jack-ellis.jpg" class="w-10 h-10 object-cover object-center" alt="Jack Ellis" width="40" height="40" loading="lazy" />
            <div class="text-xs">
    ...
    <footer class="relative pt-12">
      <div class="max-w-screen-2xl mx-auto w-full px-5">
            ...
            <ul class="mt-6 flex items-center space-x-3">
              <li>
                <a href="https://x.com/laravelphp">
                  <img class="hidden w-6 h-6" src="assets/img/social/x.dark.min.svg" alt="X" width="24" height="20" loading="lazy" />
                  <img class="inline-block w-6 h-6" src="assets/img/social/x.min.svg" alt="X" width="24" height="20" loading="lazy" />
                </a>
              </li>
              <li>
                <a href="https://github.com/laravel">
                  <img class="hidden w-6 h-6" src="assets/img/social/github.dark.min.svg" alt="GitHub" width="24" height="24" loading="lazy" />
                  <img class="inline-block w-6 h-6" src="assets/img/social/github.min.svg" alt="GitHub" width="24" height="24" loading="lazy" />
                </a>
              </li>
              <li>
                <a href="https://discord.gg/laravel">
                  <img class="hidden w-6 h-6" src="assets/img/social/discord.dark.min.svg" alt="Discord" width="21" height="24" loading="lazy" />
                  <img class="inline-block w-6 h-6" src="assets/img/social/discord.min.svg" alt="Discord" width="21" height="24" loading="lazy" />
                </a>
              </li>
              <li>
                <a href="https://www.youtube.com/laravelphp">
                  <img class="hidden w-6 h-6" src="assets/img/social/youtube.dark.min.svg" alt="YouTube" width="169" height="150" loading="lazy" />
                  <img class="inline-block w-6 h-6" src="assets/img/social/youtube.min.svg" alt="YouTube" width="169" height="150" loading="lazy" />
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <div class="mt-5">
              <ul class="space-y-3 text-gray-700">
                ...
                <li>
                  <a href="https://laravel.com/careers" class="transition-colors hover:text-gray-600">Careers</a>
                </li>
                <li>
                  <a href="https://larajobs.com/?partner=5" class="transition-colors hover:text-gray-600">Jobs</a>
                </li>
                <li>
        ...
        <div class="mt-10 border-t pt-6 pb-16 border-gray-200">
          ...
          <p class="mt-6 text-xs text-gray-700">Code highlighting provided by <a href="https://torchlight.dev">Torchlight</a></p>
        </div>
      </div>
    </footer>
