(function (w) {
  ...
  if (!tracking.initialize) {
    if (tracking.invoked) {
      ...
      (tracking.invoked = !0),
        (tracking.methods = ["trackSubmit", "trackClick", "trackLink", "trackForm", "pageview", "identify", "reset", "group", "track", "ready", "alias", "page", "once", "off", "on"]),
  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          Object.defineProperty(exports, "__esModule", { value: !0 }),
            (exports.tryClearbitIdentify =
              ...
              exports.canAutomaticallyIdentify =
                void 0);
          var e = ["login", "register", "signup", "sign-up", "signin", "sign-in", "auth", "create-account", "contact", "about", "request", "pricing"],
            i = ["wpforms-form", "elementor-form", "hs-form", "jotform-form"],
            n = ["formspree", "getform", "list-manage", "mailerlite", "mandrill", "sendgrid", "sendinblue", "activehosted"];
          function o(e) {
          ...
          function r() {
            ...
            return (
              ...
              Boolean((null === (e = window.analytics) || void 0 === e ? void 0 : e.SNIPPET_VERSION) || (null === (i = window.analytics.settings) || void 0 === i ? void 0 : i.writeKey))
            );
          }
          function d() {
          ...
          function a() {
            var e;
            return !!(null === (e = null === window || void 0 === window ? void 0 : window.mixpanel) || void 0 === e ? void 0 : e.people);
          }
          function l() {
            return window.heap && o(window.heap.addUserProperties);
          }
          function s(e) {
            return !!t() && ("any" === e ? r() || d() || a() || l() : "segment" === e ? r() : "amplitude" === e ? d() : "mixpanel" === e ? a() : "heap" === e && l());
          }
          function u() {
            return "undefined" != typeof document && "undefined" != typeof window && void 0 !== document.addEventListener && void 0 !== document.querySelector && void 0 !== window.fetch && "undefined" != typeof Promise;
          }
          function c() {
          ...
          function f(e) {
            return !!/^\S+@\S+\.\S+$/.test(e) && !/@(?:hotmail|gmail|googlemail|yahoo|gmx|ymail|outlook|bluewin|protonmail|t-online|web\.|online\.|aol\.|live\.)/i.test(e);
          }
          function m(e) {
            return (null == e ? void 0 : e.userId) ? e.userId : (null == e ? void 0 : e.user_id) ? e.user_id : (null == e ? void 0 : e.email) ? e.email : (null == e ? void 0 : e.Email) ? e.Email : void 0;
          }
          function v(e, i, n) {
            var o, t, r, d;
            if (i) {
              var a = "sessionStorage" in window && (null === (o = null === window || void 0 === window ? void 0 : window.sessionStorage) || void 0 === o ? void 0 : o.setItem);
              if (a && (null === (r = (t = window.sessionStorage).getItem) || void 0 === r ? void 0 : r.call(t, "cbi")) === i.toString()) return !1;
              var l = JSON.parse(JSON.stringify(n || {}));
              if (((l.method = e), null === (d = null === window || void 0 === window ? void 0 : window.clearbit) || void 0 === d ? void 0 : d.identify))
                          ...
                          if (d instanceof Function) {
                            try {
                              if (!s.__isProxy) {
                                ...
                                (v = (null == p ? void 0 : p.user_id) ? p.user_id : (0, n.extractUserIdFromTraits)(m)), (0, n.tryClearbitIdentify)("amplitude", v, m);
                              }
                            } catch (_) {}
      ...
      ybEZ: [
        function (require, module, exports) {
          ...
          var e = require("./util");
          function t() {
            "readyState" in document && "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", r, !1) : r();
          }
          function r() {
            document.querySelectorAll("form").forEach(function (e) {
              e.hasAttribute("data-cb-wrapper") || (e.addEventListener("submit", a, { capture: !0, passive: !1 }), e.setAttribute("data-cb-wrapper", "true"));
            });
          }
          function a(t) {
            try {
              ...
              ((0, e.isCurrentPathLooksValuable)() || (0, e.isCurrentFormLooksValuable)(a)) && (0, e.tryClearbitIdentify)("form", r, { email: r });
            } catch (u) {}
          }
      ...
      rXKW: [
        function (require, module, exports) {
          ...
          var t =
            (this && this.__spreadArray) ||
            function (r, t, e) {
              if (e || 2 === arguments.length) for (var o, n = 0, i = t.length; n < i; n++) (!o && n in t) || (o || (o = Array.prototype.slice.call(t, 0, n)), (o[n] = t[n]));
      ...
      fqEG: [
        function (require, module, exports) {
          ...
          var t =
            (this && this.__spreadArray) ||
            function (e, t, o) {
              if (o || 2 === arguments.length) for (var r, n = 0, i = t.length; n < i; n++) (!r && n in t) || (r || (r = Array.prototype.slice.call(t, 0, n)), (r[n] = t[n]));
          ...
          function r() {
            var r;
            (null === (r = null === window || void 0 === window ? void 0 : window.mixpanel) || void 0 === r ? void 0 : r.people) &&
                      ...
                      ? function () {
                          ...
                          if (c instanceof Function) {
                            try {
                              if (!r.__isProxy) {
                                var f = void 0;
                                "string" == typeof p[0] ? ((f = f || {})[p[0]] = p[1]) : "object" === e(p[0]) && (f = p[0]);
      ...
      rxXe: [
        function (require, module, exports) {
          ...
          var e =
            (this && this.__spreadArray) ||
            function (t, e, r) {
              if (r || 2 === arguments.length) for (var o, n = 0, i = e.length; n < i; n++) (!o && n in e) || (o || (o = Array.prototype.slice.call(e, 0, n)), (o[n] = e[n]));
            ...
            return function () {
              ...
              try {
                if ("post" === (o[1] && o[1].method ? o[1].method : "GET").toLowerCase()) {
                  ...
                  !(0, e.canAutomaticallyIdentify)("any") && (0, e.isCurrentPathLooksValuable)() && (0, e.tryClearbitIdentify)("fetch", a, { email: a });
                }
              } catch (c) {}
      ...
      DPGg: [
        function (require, module, exports) {
          "use strict";
          Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.automaticIdentifies = exports.setAnalyticsLibraryWrapped = void 0);
          var e = require("./util"),
        ...
        { "./util": "BHXf", "./wrap-amplitude-identify": "bOht", "./wrap-form-submit": "ybEZ", "./wrap-heap-user-properties": "rXKW", "./wrap-mixpanel-people": "fqEG", "./wrap-segment-identify": "rxXe", "./wrap-window-fetch": "GliP" },
      ],
      QCba: [
        function (require, module, exports) {
          "use strict";
